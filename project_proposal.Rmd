...
sorted.deaths <- dplyr::arrange(deaths.all, Year, Month)
write_csv(sorted.deaths["Assault (Homicide)"],"only_the_data_im_using.csv")
```

```{r}
deaths <- ts(sorted.deaths["Assault (Homicide)"], start = 2014, frequency = 12)
